(function () {
    ...
    editButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            var repoUrl = 'https://github.com/opendocsg/opendoc-nhp' + '/blob/master/'
    ...
    printButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            var replacedRepoName = 'opendocsg/opendoc-nhp'.replace(/\//g, '-') + (isProd ? '' : '-staging')
            var pdfUrl = 'true' === 'true' ?
                '/opendoc-nhp/assets/pdfs' :
